...
function FormCreateCategory({ productUpdate = {}, onSubmit }) {
        ...
        <form onSubmit={handleSubmit(handleOnSubmit)}>
            <Box sx={{
                ...
                <Typography variant='h5' sx={{ color: myColor.greenDefault, padding: "5px 0px ", fontWeight: "bold", textAlign: "center", margin: "10px 0" }}>
                    {productUpdate?.name ? "Cập Nhật Danh Mục" : "Thêm Mới Danh Mục"}
                </Typography>
                ...
                <Box sx={{
                    ...
                    <InputField defaultValue={productUpdate.name} sx={{ marginTop: "15px" }} form={form} name="name" label="Tên Danh Mục" />
                    <InputField sx={{ marginTop: "15px" }} type="number" form={form} name="originPrice" label="SLug" />
                    ...
                    <Box mt="15px" textAlign="center"><Button type='submit' fullWidth variant="contained" sx={{
                        ...
                        {productUpdate?.name ? "Cập Nhật Danh Mục" : "Tạo Danh Mục"}
